...
function showDataCollection() {
    const modal = `
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50" id="dataCollectionModal">
            <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-bold text-gray-900">Import Data</h3>
                    <button onclick="closeModal('dataCollectionModal')" class="text-gray-400 hover:text-gray-600">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button onclick="showAPIImport()" class="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-indigo-500 hover:bg-indigo-50 transition-all">
                        ...
                        <button onclick="showFileUpload()" class="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all">
                        ...
                        <button onclick="showWebScraping()" class="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-all">
                        ...
                        <button onclick="showDatabaseConnect()" class="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-yellow-500 hover:bg-yellow-50 transition-all">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="space-y-2">
                            <button onclick="importTemplate('sdss_galaxies')" class="w-full text-left p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all">
