...
# Исправленное развертывание Scientific API
# Использует правильный Python образ с корректным экранированием
...
echo -e "${GREEN}=== Исправленное развертывание Scientific API ===${NC}"
...
# Создаем контейнер с правильной командой
...
az container create \
    ...
    --command-line "sh -c \"pip install requests fastapi uvicorn && python3 -c \\\"
import uvicorn
