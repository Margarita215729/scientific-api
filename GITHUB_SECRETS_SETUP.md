...
- Токен отображается только один раз при создании
...
#### Вариант 1: Использование аккаунта cutypie (основной)
...
**Важно**: Для Docker Hub нужно использовать Personal Access Token, а не пароль от аккаунта!

#### Вариант 2: Использование аккаунта gretk (альтернативный)
