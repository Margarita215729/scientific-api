...
# Scientific API - Updated configuration

set -e

echo "🚀 Deploying Scientific API to Azure Web App..."

# Configuration from Azure deployment JSON
...
az deployment group create \
    ...
    --parameters \
        ...
        virtualNetworks_vnet_euoxdfir_externalid="/subscriptions/$SUBSCRIPTION_ID/resourceGroups/$RESOURCE_GROUP/providers/Microsoft.Network/virtualNetworks/vnet-euoxdfir"
...
echo ""
echo -e "${GREEN}🎉 Deployment complete! Your Scientific API is now running on Azure Web App.${NC}" 